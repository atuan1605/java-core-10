...
public class ProductService {
    ...
    public void allProduct(ArrayList<Product> list){
        for (Product p : list){
    ...
    public ArrayList<Product> getProductQuantityLess5(ArrayList<Product> list, int quantity){
    ...
    public ArrayList<Product> getProductPrice1(ArrayList<Product> list ){
        ArrayList<Product> price1 = new ArrayList<>();
        for (Product p : list){
            if (p.getPrice() < 50000 ){
                price1.add(p);
            }
    ...
    public ArrayList<Product> getProductPrice2(ArrayList<Product> list){
        ArrayList<Product> price2 = new ArrayList<>();
        for (Product p : list){
    ...
    public ArrayList<Product> getProductPrice3(ArrayList<Product> list){
        ArrayList<Product> price3 = new ArrayList<>();
        for (Product p : list){
