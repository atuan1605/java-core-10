...
public class BookService {
    public Book addBook(){
        ...
        book.publishingCompany = sc.nextLine();
    ...
    public void findBooksByCompany(Book[] arrBooks, String publishingCompany){
        for(Book i : arrBooks){
            if (i.publishingCompany.contains(publishingCompany)){
                System.out.println(i);
            }
        }
    }
